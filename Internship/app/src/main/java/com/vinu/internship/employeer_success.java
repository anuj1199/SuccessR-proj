...
public class employeer_success extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        { case R.id.nav_all_logout:
            ...
            finish();
            Toast.makeText(employeer_success.this,"Logged out Successfully",Toast.LENGTH_LONG).show();
            finish();
            break;
            ...
            case R.id.nav_notifications_upload:
                Intent not = new Intent(employeer_success.this,uploadnotification.class);
                startActivity(not);
                break;
