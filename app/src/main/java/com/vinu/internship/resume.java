...
public class resume extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( TextUtils.isEmpty(value)){
                    ...
                    Intent i = new Intent(resume.this, resume.class);
                    startActivity(i);
                }
                    ...
                    Intent i = new Intent(resume.this, resume_preview.class);
                    ...
                    mDatabaseReference.child("users").child(phone.getText().toString()).push().setValue(user);
                    finish();
                }
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(resume.this, resumeupdate.class);
                startActivity(i);
            }
        });
