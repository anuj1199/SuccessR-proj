            ...
            public void onClick(View v) {
                ...
                if((((wificonn != null) && wificonn.isConnected()) || ((mobileconn != null) && mobileconn.isConnected())))
                {
                    if(!TextUtils.isEmpty(Emailid) && !TextUtils.isEmpty(Password)) {
                        final ACProgressFlower dialoglogin = new ACProgressFlower.Builder(employeelogin.this)
                        ...
                        firebaseAuth.signInWithEmailAndPassword(Emailid, Password)
                                .addOnCompleteListener(employeelogin.this, new OnCompleteListener<AuthResult>() {
                                    @Override
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        ...
                                        if (task.isSuccessful()) {
                                            if (firebaseAuth.getCurrentUser().isEmailVerified()) {
                                                ...
                                                Toast.makeText(employeelogin.this, "Please Verify your mailid first", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                        else
                                        {
                                            Toast.makeText(employeelogin.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                                        }
                                        dialoglogin.dismiss();
                                    }
                                });
                ...
                {
                    Toast.makeText(employeelogin.this,"Please check Your Internet Connection",Toast.LENGTH_LONG).show();
                }
            }
        });
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(employeelogin.this, "User Signed In", Toast.LENGTH_SHORT).show();
                        } else {
